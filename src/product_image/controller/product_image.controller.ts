...
import { Public, RequireResource } from 'src/auth/decorator/auth.decorator';
...
export class ProductImageController {
    ...
    async update(
        ...
        const result = await this.productImageService.update(id, updateProductImageDto);
        return {
            success: true,
    ...
    async reorderImages(
        ...
        const result = await this.productImageService.reorderImages(productId, imageIds);
        return {
            success: true,
